...
import { QUERY_ASISTENCIA_BY_ALUMNO }       from '../../queries';

import '../css/Header.css';
import '../css/DropdownDemo.css';


class Desempeño extends Component {
                    ...
                    <form className="col-md-11 m-3" >
                        ...
                        <div className="datatable-editing-demo">
                            ...
                            <div className="card p-fluid">
                                ...
                                <Query  query = {QUERY_ASISTENCIA_BY_ALUMNO} 
                                    ...
                                    if(data.CoreAsistenciaByAlumno.length === 0) {
                                        ...
                                        return (
                                            ...
                                            <Fragment>
                                                ...
                                                <DataTable  value={data.CoreAsistenciaByAlumno} 
                                                        editMode="row" 
                                                        dataKey="id" 
